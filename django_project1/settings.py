...
SECRET_KEY = 'z)k35uj0!qzwx@newiy5^7((7)$2$1j-ifw((5+_%2x)kepvkt'
...
STATICFILES_DIRS = [
    'C:/myenv/django/django_project1/blog/templates/blog/static'
]
STATIC_URL = '/static/'

#dir where django stores uploaded files
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
#tells django how we will access that uploaded file in the browser
MEDIA_URL = '/media/'
